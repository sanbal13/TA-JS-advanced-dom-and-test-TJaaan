...
var alphaOne = ['a', 'b', 'c', 'd', 'e'];
var alphaTwo = ['f', 'g', 'h', 'd', 'e'];
/* Arrray methods */

var concat = lodash.concat(alphaOne, alphaTwo, 1, 2, 3, 'p', 'q');
console.log(concat);
var fill = lodash.fill(alphaOne, 1, 1, 3);
console.log(fill);
var obj = lodash.fromPairs([['name', 'Arya'], ['house', 'Starks']]);
console.log(obj);
var pairs = lodash.toPairs({
  name: 'John',
  age: '20'
});
console.log(pairs);
var intersection = lodash.intersection(alphaOne, alphaTwo);
console.log(intersection);
/* Collection methods */

var numOne = [1.33, 1.2, 4.53, 3.6, 2.43, 3.2];
var countBy = lodash.countBy(numOne, Math.floor);
console.log(countBy);
var lastLessThanThree = lodash.findLast(numOne, function (n) {
  return n < 3;
});
console.log(lastLessThanThree);
var length = lodash.groupBy(numOne.map(function (elm) {
  return elm.toString();
}), 'length');
console.log(length);
var includes = lodash.includes(numOne, 3.5);
console.log(includes);
var partition = lodash.partition(numOne, function (n) {
  return n > 2;
});
